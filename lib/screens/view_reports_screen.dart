...
//
// Patient-facing screen — lists the logged-in patient's medical reports
// and opens them via PdfViewerScreen (cross-platform, no dart:html here).
      ...
      leading: GestureDetector(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
              color: softBlue, borderRadius: BorderRadius.circular(9)),
    ...
    return Center(
      child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
        Container(
          ...
          height: 80,
          decoration:
              const BoxDecoration(color: softBlue, shape: BoxShape.circle),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(children: [
                    ...
                    const SizedBox(width: 6),
                    Expanded(
                      child: Text('By ${report.uploadedBy}',
                          style: TextStyle(
                              fontSize: 12, color: Colors.grey.shade600),
                  ...
                  if (report.fileUrl != null &&
                    ...
                    SizedBox(
                      ...
                      child: OutlinedButton.icon(
                        onPressed: () async {
                          final viewUrl = SupabaseStorageService
                              .prepareViewUrl(report.fileUrl!);
                          try {
                            await openFileUrl(
                              context,
                              viewUrl,
