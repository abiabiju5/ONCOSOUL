...
class _PatientDashboardState extends State<PatientDashboard> {
  ...
  Widget build(BuildContext context) {
    ...
    double bannerHeight =
        screenWidth < 600 ? 220 : screenWidth < 1100 ? 250 : 280;
    double titleSize =
        screenWidth < 600 ? 26 : screenWidth < 1100 ? 30 : 34;
    double subtitleSize =
        screenWidth < 600 ? 14 : screenWidth < 1100 ? 16 : 17;
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      // Original logo: volunteer_activism (hand with love)
                      const Row(
                        children: [
                      ...
                      // Bell + Logout only (profile fully removed)
                      Row(
                        children: [
                          ...
                          // Logout — blue, shows confirmation
                          GestureDetector(
                  ...
                  child: ClipRRect(
                    ...
                    child: Stack(
                      children: [
                        ...
                        // Soft white-blue wash — low opacity
                        Positioned.fill(
                          child: Container(
                            decoration: BoxDecoration(
                              gradient: LinearGradient(
                                colors: [
                                  const Color(0xFFE8F1FB).withValues(alpha: 0.78),
                                  const Color(0xFFF0F6FF).withValues(alpha: 0.45),
                                  Colors.transparent,
                                ],
                        ...
                        children: [
                          Expanded(
                            child: _card(
                              ...
                              const Color(0xFFA85820),
                              const Color(0xFFF5E2CC),
                            ),
                          ),
                          const SizedBox(width: 20),
                          Expanded(
  ...
  // ── Card — exact same height/width/structure, no arrow ───────────
  Widget _card(
